                                    ...
                                    <div class="form-group row"><label class="col-lg-1 col-form-label">Nombre:* </label>
                                        ...
                                        <div class="col-lg-10">
                                             <input type="text" placeholder="Nombre" name="nombre"
                                                class="form-control"value="{{ old('nombre', $proveedor->nombre)}}"> 
                                        </div>
                                    </div>
                                    @error('nombre')
                                    ...
                                    <div class="form-group row"><label class="col-lg-1 col-form-label">Apellidos: </label>
                                        ...
                                        <div class="col-lg-10">
                                             <input type="text" placeholder="Apellidos" name="apellidos"
                                                class="form-control"value="{{ old('apellidos', $proveedor->apellidos) }}"> 
                                        </div>
                                    </div>
                                    @error('apellidos')
                                                <small class="text-danger d-block mt-1">{{ $message }}</small>
                                    ...
                                    <div class="form-group row"><label class="col-lg-1 col-form-label">Teléfono:* </label>
                                        ...
                                        <div class="col-lg-10">
                                             <input type="number" placeholder="Telefono" name="telefono"
                                                class="form-control"value="{{ old('telefono', $proveedor->telefono) }}"> 
                                        </div>
                                    </div>
                                    @error('telefono')
                                                <small class="text-danger d-block mt-1">{{ $message }}</small>
                                    ...
                                    <div class="form-group row"><label class="col-lg-1 col-form-label">Dirección: </label>
                                        ...
                                        <div class="col-lg-10">
                                             <input type="text" placeholder="Direccion" name="direccion"
                                                class="form-control"value="{{ old('direccion',$proveedor->direccion) }}"> 
                                        </div>
                                    </div>
                                    @error('correo')
                                                <small class="text-danger d-block mt-1">{{ $message }}</small>
